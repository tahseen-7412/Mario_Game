...
function MarioGame() {
  ...
  this.showInstructions = function() {
    gameUI.writeText('Controls: Arrow keys for direction, shift to run, ctrl for bullets', 30, 40);
    gameUI.writeText('Tip: Jumping while running makes you jump higher', 30, 70);
  };
  ...
  this.gameOver = function() {
    ...
    gameUI.writeText('Thank you for playing', centerPos - 122, height / 2);
  };
